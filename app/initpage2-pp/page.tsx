                ...
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-slate-600 mt-6 max-w-2xl mx-auto leading-relaxed">
                            This is not a spy app. This is <strong className="text-teal-700">tactical emotional preparation</strong>. Designed to be used minutes before a difficult conversation, this protocol gives you the mental strength to handle any outcome with dignity and power.
                        </p>
                    </div>
